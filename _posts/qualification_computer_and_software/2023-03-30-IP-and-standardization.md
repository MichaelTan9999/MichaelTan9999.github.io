...
软件作品在委托创作中，著作权一般归于创作方，但是按照合同约定归委托方的除外。软件作品在合作开发中，只进行组织、提供咨询意见物质条件或其他辅助工作的，不享有著作权；共同参与创作的，按人头比例或者对可分割成果分开申请。
...
不知情的情况下使用盗版软件，在明确提供方不能提供复制品合法来源的情况下，持有者和提供者均需承担法律责任。
